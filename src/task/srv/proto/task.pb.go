...
type IsAllowedSrvQuery struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	SrvAddr    string `protobuf:"bytes,1,opt,name=srv_addr,json=srvAddr,proto3" json:"srv_addr,omitempty"`
	WorkerAddr string `protobuf:"bytes,2,opt,name=worker_addr,json=workerAddr,proto3" json:"worker_addr,omitempty"`
}

func (x *IsAllowedSrvQuery) Reset() {
	*x = IsAllowedSrvQuery{}
	if protoimpl.UnsafeEnabled {
...
func (x *IsAllowedSrvQuery) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsAllowedSrvQuery) ProtoMessage() {}

func (x *IsAllowedSrvQuery) ProtoReflect() protoreflect.Message {
	mi := &file_proto_task_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsAllowedSrvQuery.ProtoReflect.Descriptor instead.
func (*IsAllowedSrvQuery) Descriptor() ([]byte, []int) {
	return file_proto_task_proto_rawDescGZIP(), []int{11}
}

func (x *IsAllowedSrvQuery) GetSrvAddr() string {
	if x != nil {
		return x.SrvAddr
	}
	return ""
...
func (x *IsAllowedSrvQuery) GetWorkerAddr() string {
	if x != nil {
		return x.WorkerAddr
	}
	return ""
...
var file_proto_task_proto_rawDesc = []byte{
	...
	,
}
...
var file_proto_task_proto_goTypes = []interface{}{
	...
	(*IsAllowedSrvQuery)(nil), // 11: task.IsAllowedSrvQuery
	nil,                       // 12: task.QueryWithPage.QueryEntry
}
var file_proto_task_proto_depIdxs = []int32{
	12, // 0: task.QueryWithPage.query:type_name -> task.QueryWithPage.QueryEntry
	...
	11, // 10: task.TaskService.IsAllowedSrv:input_type -> task.IsAllowedSrvQuery
	1,  // 11: task.TaskService.ListTasks:output_type -> task.PagedTasks
	2,  // 12: task.TaskService.ListSchedules:output_type -> task.PagedSchedules
	5,  // 13: task.TaskService.GetResult:output_type -> task.Result
	7,  // 14: task.TaskService.CallTask:output_type -> task.TaskUniqueId
	10, // 15: task.TaskService.KillTask:output_type -> task.BoolMsg
	10, // 16: task.TaskService.SetTaskStatus:output_type -> task.BoolMsg
	10, // 17: task.TaskService.AppendTaskLog:output_type -> task.BoolMsg
	10, // 18: task.TaskService.IsAllowedSrv:output_type -> task.BoolMsg
...
func file_proto_task_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_task_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*IsAllowedSrvQuery); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
